...
#macro SCRIBBLE_INCLUDED_FILES_SUBDIRECTORY   "json" //The directory to look in for font .yy files, relative to the root folder that Included Files are stored in
